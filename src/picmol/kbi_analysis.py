...
def main():
  ...
  parser.add_argument('--rdf_dir', default='rdf_files', help='Name for rdf directory in each system (default: rdf_files)')
  parser.add_argument('--kbi_dir', default='kbi_analysis', help='Name for directory for kbi analysis (default: kbi_analysis)')
  parser.add_argument('--kbi_method', default='adj', choices=['raw', 'adj', 'kgv'], help='KBI method name (default: adj)')
  ...
  parser.add_argument('--thermo_model', default='quartic', choices=['quartic', 'uniquac', 'unifac', 'nrtl', 'fh'], help='Thermodynamic model name for LLE calculation (default: quartic)')
  ...
  kbi_obj = KBI(prj_path=args.prj_path, pure_component_path=args.pure_component_path, rdf_dir=args.rdf_dir, kbi_method=args.kbi_method, avg_start_time=args.start_time, avg_end_time=args.end_time, kbi_fig_dirname=args.kbi_fig_dirname)
